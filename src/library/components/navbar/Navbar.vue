        ...
        >
          ...
          -->
            <div
              ...
              :class="{'hidden': !userMenuVisible, 'block': userMenuVisible}"
              role="menu"
  ...
  methods:{
    ...
    toggleUserMenu(){
      ...
      const onClickAway = (event)=>{
        console.log('event', event.target, menu);
        if (!menu == event.target && !menu.contains(event.target)){
          console.log('menu,event.target', menu,event.target)
        }
      }; */
